...
import '../App.css'; // Assuming you've created a separate CSS file for animations
...
export default function Signup() {
  ...
  return (
    <div className="container-fluid m-0 p-0">
      ...
      <div className="container border border-3 border-light rounded-3 mt-5 form-container">
              ...
              <div className="row">
                ...
                <div className="col-6">
                  ...
                  <div className="row">
                    ...
                    <div className="col-6">
                      <Form.Item label="Address Line 2" name="addressLine2"                     className="form-item"
                      >
                ...
                <div className="col-12 text-center ">
                  <Form.Item>
                    <Button
                      ...
                      htmlType="submit"
                      block
                      className="w-25 mt-4 fs-5 fw-thin form-item"
                    >
                      Register
                    </Button>
                  </Form.Item>
